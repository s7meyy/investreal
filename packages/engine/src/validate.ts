...
export function validate(o: Opportunity): string[] {
  ...
  if (market > 0 && o.deal.contractRentAnnual >= market) {
    w.push('الإيجار التعاقدي يساوي إيجار السوق أو يتجاوزه — لا يوجد فرق تربح منه، فهذه ليست فرصة استثمارية بهذا الشكل. راجع الرقمين: هل أدخلتهما في مكانيهما الصحيحين؟');
  }
