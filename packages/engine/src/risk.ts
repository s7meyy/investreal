...
/**
 * «غير معروف» = ٦٠٪ من الخطر الكامل.
 *
 * الجهل ليس أماناً، لكنه ليس إدانة: بند لم يُتحقَّق منه قد يكون سليماً.
 * لو ساويناه بـ«لا» لصار مَن لم يُجب شيئاً بعد يرى فرصته «حرجة» ثم
 * «مرفوضة» قبل أن يبدأ — وهذا حكم على المستخدم لا على الفرصة.
 * بهذه النسبة: مَن لا يعرف شيئاً تكون مخاطرته «مرتفعة»، ومَن أجاب
 * بـ«لا» على كل شيء تكون «حرجة». وهذا هو الترتيب الصحيح.
 */
